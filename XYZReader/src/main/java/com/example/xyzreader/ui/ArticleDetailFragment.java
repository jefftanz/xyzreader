...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPhotoView = (ImageView) mRootView.findViewById(R.id.image_ActivityDetail);
...
//            final ImageView image = (ImageView) mRootView.findViewById(R.id.image_ActivityDetail);
//
//            Picasso.with(getActivity()).load(mCursor.getString(ArticleLoader.Query.PHOTO_URL).into(image, new Callback() {
//                @Override
...
//            });
    ...
    private void applyPalette(Palette palette) {
        ...
        updateBackground((FloatingActionButton) getActivity().findViewById(R.id.share_fab), palette);
